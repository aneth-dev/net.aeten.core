...
public class StringUtil {
	...
	private static int findNextQuote(String arguments, int begin, char quote) {
		...
		for (int i = begin; i < arguments.length(); i++) {
			if (!isEscaped && (arguments.charAt(i) == quote)) { return i; }
	...
	public static void main(String[] arguments) {
		doAssertion(splitWithQuote("-a toto -b titi"), new String[] {	"-a",
																							"toto",
																							"-b",
																							"titi"
		});
		doAssertion(splitWithQuote("-a toto -b titi -c \"tutu titi\\\"\" -d tata"), new String[] { "-a",
																																"toto",
																																"-b",
																																"titi",
																																"-c",
		...
		doAssertion(splitWithQuote("-a toto -b \"-c \\\"titi\\\"\""), new String[] {	"-a",
																												"toto",
																												"-b",
																												"-c \"titi\""
		});
