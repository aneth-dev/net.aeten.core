...
public class AsynchronousTransmitter<Event, Data extends EventData<?, Event>> implements TransmitterService<Event, Data> {
	...
	@Override
	public void start() {
		if (executorService.isShutdown()) { throw new IllegalStateException("Transmitter service is already running"); }
		if (executorServiceFactory == null) { throw new UnsupportedOperationException("None executor service factory given"); }
